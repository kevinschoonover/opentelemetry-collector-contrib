...
func (m *mockMetadata) NodeID(context.Context) (string, error) {
	args := m.MethodCalled("NodeID")
	return args.String(0), args.Error(1)
}

func (m *mockMetadata) Datacenter(context.Context) (string, error) {
	args := m.MethodCalled("Datacenter")
	return args.String(0), args.Error(1)
}
...
func TestDetect(t *testing.T) {
	...
	md.On("Datacenter").Return("dc1", nil)
	md.On("NodeID").Return("00000000-0000-0000-0000-000000000000", nil)
